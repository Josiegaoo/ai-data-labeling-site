...
export default function IndustryTrends() {
  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-center p-8 bg-gradient-to-br from-blue-100 via-purple-100 to-pink-100">
      <ArrowTrendingUpIcon className="h-16 w-16 text-purple-500 mb-4" />
      <h1 className="text-3xl font-bold mb-8">{language === 'en' ? 'Industry Trends' : '行业趋势'}</h1>
      <div className="w-full max-w-6xl grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
        {trends.map((trend, idx) => {
          ...
          return (
            ...
            >
              <button
                className="w-full h-full flex flex-col justify-center items-center px-4 py-2 font-semibold text-lg focus:outline-none bg-transparent"
              ...
              {openIndex === idx && (
                <div className="bg-white/90 rounded-b-xl px-6 py-6 border-t border-purple-200 mt-2">
